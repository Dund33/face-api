...
async def main():
    ...
    false_reject_users = [user for user in registered_users if user.id in false_reject_ids]
    false_accept_users = [user for user in registered_users if user.id in false_accept_ids]
